...
const Practice = () => {
    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            ...
            <p>Here is an example of how to create an object using a constructor in JavaScript/React.</p>
            ...
            <div style={{ backgroundColor: '#e8f4fd', padding: '15px', borderRadius: '5px', margin: '10px 0' }}>
                <h4>Code Example:</h4>
